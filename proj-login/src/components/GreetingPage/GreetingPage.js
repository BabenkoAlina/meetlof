            ...
            <div className={styles["explore-topic"]}>
              ...
              <div className={styles["explore-table"]}>
                ...
                <p>
                  ...
                  offers a wide range of icebreaker categories suitable for any
                  team meeting or classroom setting. The website provides easy
                  access to over 100 questions designed to help team members
            ...
            <div className={styles["explore-topic"]}>
              ...
              <div className={styles["explore-table"]}>
                ...
                <p>
                  ...
                  and instant-messaging services may make it more convenient to
                  communicate with our friends and family, but it can be hard to
                  get to know a new person when you aren't speaking
                  face-to-face. More and more people are meeting their friends,
                  partners, and spouses on the Internet, and here's the thing:
                  it's awkward for everyone! Be curious, but not pushy; relax,
                  and try to be yourself. More here:
                  <br />
